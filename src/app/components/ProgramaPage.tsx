...
export function ProgramaPage() {
  ...
  return (
    <div style={{ backgroundColor: "#1A1A2E", overflowX: "hidden" }}>
      ...
      <section style={{ paddingTop: isMobile ? "140px" : "188px", paddingBottom: isMobile ? "80px" : "132px", paddingLeft: px, paddingRight: px, position: "relative", overflow: "hidden", minHeight: "100vh", display: "flex", flexDirection: "column", justifyContent: "center" }}>
        ...
        <div style={{ maxWidth: "700px", margin: "0 auto", position: "relative", zIndex: 1, textAlign: "center" }}>
          ...
          <p style={{ fontFamily: "Space Grotesk, sans-serif", fontWeight: 300, fontSize: isMobile ? "15px" : "18px", color: "#8888AA", lineHeight: "1.7", marginBottom: "42px", maxWidth: "500px", margin: "0 auto 42px" }}>
          ...
          <div style={{ backgroundColor: "#1E1E36", borderRadius: "12px", padding: isMobile ? "28px 24px" : "38px 40px", border: "1px solid #252540", marginBottom: "34px", textAlign: "left" }}>
