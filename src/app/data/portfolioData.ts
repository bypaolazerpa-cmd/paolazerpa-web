...
export const portfolioData: Record<string, PortfolioCaseStudy> = {
  ...
  gestock: {
    ...
    sections: [
      ...
      { number: "06", label: "Decisiones", blocks: [
        { title: "Centralizar información que antes se consultaba en distintos lugares.", copy: "", visual: visual("Estructura", "Organización de información") },
        { title: "Diseñar los flujos desde tareas reales de operación y no desde una estructura abstracta del sistema.", copy: "", visual: visual("Flujo", "Flujo de operación") },
        { title: "Probar decisiones en el contexto donde realmente iban a utilizarse.", copy: "", visual: visual("Recorrido", "Prueba en contexto real") },
      ] },
  ...
  "operacion-de-tienda": {
    ...
    sections: [
      ...
      { number: "05", label: "Sistemas creados", blocks: ["organización de tareas", "seguimiento", "vencimientos", "proveedores", "registros operativos", "controles"].map((title) => ({ title, copy: "Herramientas, tableros, registros y formas de trabajo.", visual: visual("Módulo", title) })) },
