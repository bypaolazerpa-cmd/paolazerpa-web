...
export const routeMetadata: Record<string, PageMetadata> = {
  ...
  "/portfolio/nodux": {
    title: "NODUX — Case Study | Paola Zerpa",
    description:
      "Case study de Product Design sobre la evolución de NODUX, un producto digital que conecta gestión comercial y tienda online.",
  },
  "/portfolio/gestock": {
    title: "GeStock — Case Study | Paola Zerpa",
    description:
      "Case study sobre cómo problemas reales de operación se transformaron en un sistema digital de gestión.",
  },
  "/portfolio/operacion-de-tienda": {
    title: "Sistemas de operación de tienda | Paola Zerpa",
    description:
      "Caso sobre diseño de sistemas de trabajo para organizar información, procesos y responsabilidades en una operación real.",
  },
  "/portfolio/cosmic-studio": {
    title: "Cosmic Studio — Proyecto | Paola Zerpa",
    description: "Proyecto de identidad, estructura y experiencia digital para Cosmic Studio.",
  },
};
